...
<c:set var="journal" value="${section.courseJournal}" />
...
(a.k.a. <em>ABET Syllabus</em>).
<c:if test="${isCoordinator}">
As the coordinator of this course, you can click <a
...
<ul>
  ...
  <li><a href="../grade?enrollmentId=${enrollment.id}">${enrollment.student.name}
    (${enrollment.grade.symbol})</a></li>
  </c:forEach>
</ul>
</c:if>
</div>
